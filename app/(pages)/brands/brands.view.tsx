          ...
          <div className="flex h-96 w-full flex-col items-center justify-center gap-6 rounded-[4px] border border-dashed border-neutral-800 bg-[#171717]/20">
            ...
            {searchQuery ? (
              <Button
                ...
                className="text-blue-500 text-xs font-bold uppercase tracking-widest"
              >
                Limpar Busca
              </Button>
            ) : (
          ...
          <div className="animate-in fade-in duration-500 slide-in-from-bottom-2">
              ...
              <Table>
                <TableHeader className="bg-neutral-900/50">
                  <TableRow className="border-b border-neutral-800 hover:bg-transparent">
                    ...
                    <TableHead
                      className="cursor-pointer text-[10px] font-bold uppercase tracking-widest text-neutral-500 hover:text-white transition-colors"
            ...
            <div className="grid grid-cols-1 gap-3 md:hidden">
              {brands.map((brand) => (
                <div
                  key={brand.id}
                  className="relative flex items-center gap-4 rounded-[4px] border border-neutral-800 bg-[#171717] p-4 hover:border-neutral-700 transition-all active:bg-[#1f1f1f]"
                >
          ...
          >
            ...
            {logoPreview && (
              <div className="rounded-[4px] border border-neutral-800 bg-neutral-900/50 p-4 flex flex-col items-center justify-center min-h-[120px]">
                <span className="text-[8px] font-bold uppercase text-neutral-600 mb-3 tracking-widest">
