  ...
  if (error || !product) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-[#0A0A0A] text-neutral-400">
        ...
        <h2 className="text-xl font-bold uppercase tracking-wide text-white">Produto não encontrado</h2>
        ...
        <Link href="/products" className="mt-8">
          <Button variant="outline" className="rounded-[4px] border-neutral-800 bg-transparent text-white hover:bg-neutral-900">
            ...
            <div className="relative overflow-hidden rounded-[4px] border border-neutral-800 bg-[#171717] group">
              ...
              <div className="grid grid-cols-2 border-t border-neutral-800 bg-neutral-900/50">
                <div className="flex flex-col items-center justify-center p-3 border-r border-neutral-800">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 mb-1">Tipo</span>
                  <div className="flex items-center gap-1.5 text-xs font-medium text-white">
                    {product.isKit ? <Layers className="h-3.5 w-3.5 text-purple-500" /> : <Box className="h-3.5 w-3.5 text-blue-500" />}
                    {product.isKit ? "KIT / COMBO" : "UNITÁRIO"}
                  </div>
                </div>
                <div className="flex flex-col items-center justify-center p-3">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 mb-1">Validade</span>
                  <div className="flex items-center gap-1.5 text-xs font-medium text-white">
                    <Clock className={cn("h-3.5 w-3.5", product.hasExpiration ? "text-amber-500" : "text-neutral-500")} />
            ...
            <div className="rounded-[4px] border border-neutral-800 bg-[#171717] p-5">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-3 border-b border-neutral-800/50">
                  ...
                  <span className="text-xs font-mono text-neutral-300">{formatDateTime(product.createdAt)}</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-neutral-800/50">
                  <span className="text-xs text-neutral-500">Atualizado em</span>
                  <span className="text-xs font-mono text-neutral-300">{formatDateTime(product.updatedAt)}</span>
                </div>
                <div className="space-y-1.5 pt-1">
                  <span className="text-[10px] uppercase tracking-wider text-neutral-500">UUID do Produto</span>
                  <button 
          ...
          <div className="space-y-6 lg:col-span-8">
            ...
            <div className="rounded-[4px] border border-neutral-800 bg-[#171717] p-6 relative overflow-hidden">
              ...
              <div className="relative">
                <h1 className="text-3xl font-bold uppercase tracking-tight text-white mb-2">{product.name}</h1>
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="group flex items-center gap-4 rounded-[4px] border border-neutral-800 bg-neutral-900/50 p-4 transition-colors hover:border-neutral-700">
                    ...
                    <div className="overflow-hidden">
                      <p className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">SKU (Stock Keeping Unit)</p>
                      <p className="font-mono text-sm font-bold text-white truncate" title={product.sku || ""}>
                  ...
                  <div className="group flex items-center gap-4 rounded-[4px] border border-neutral-800 bg-neutral-900/50 p-4 transition-colors hover:border-neutral-700">
                    ...
                    <div className="overflow-hidden">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">Código de Barras</p>
                        {product.barcodeType && (
                      ...
                      <p className="font-mono text-sm font-bold text-white truncate" title={product.barcode || ""}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="rounded-[4px] border border-neutral-800 bg-[#171717] p-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xs font-bold uppercase tracking-widest text-white">Categoria</h3>
                </div>
                <div className="pl-11">
                  <p className="text-lg font-medium text-white">{product.categoryName || "Sem Categoria"}</p>
                  <p className="text-xs text-neutral-500 mt-1">Classificação principal do item no estoque</p>
                </div>
              </div>
              ...
              <div className="rounded-[4px] border border-neutral-800 bg-[#171717] p-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xs font-bold uppercase tracking-widest text-white">Marca / Fabricante</h3>
                </div>
                <div className="pl-11">
                  <p className="text-lg font-medium text-white">{product.brand?.name || "Genérico"}</p>
                  <p className="text-xs text-neutral-500 mt-1">Fabricante registrado do produto</p>
                </div>
              </div>
            </div>
