...
interface NewTransferScannerProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onScan: (barcode: string) => void;
}

export function NewTransferScanner({
  open,
  onOpenChange,
  onScan,
}: NewTransferScannerProps) {
  const handleScan = (detectedCodes: BarcodeScannerDetectedCode[]): void => {
            ...
            <div className="flex min-w-0 items-center gap-2">
              ...
              <div className="min-w-0">
                ...
                <DrawerDescription className="text-[10px] text-neutral-500">
                  Aponte para o código de barras para escolher o lote
                </DrawerDescription>
              </div>
            </div>
            <Button
